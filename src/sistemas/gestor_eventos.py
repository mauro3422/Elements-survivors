...
class GestorEventos:
    def __init__(self, jugador, hud, juego_ref):
        ...
        log_ev_handler_enabled = settings.MODO_DEBUG_LOGS and settings.LOG_CATEGORIAS.get("log_event_handler", False)
    ...
    def procesar_eventos(self, eventos_pygame):
        ...
        log_ev_handler_enabled = settings.MODO_DEBUG_LOGS and settings.LOG_CATEGORIAS.get("log_event_handler", False)
        log_ev_verbose_enabled = settings.MODO_DEBUG_LOGS and settings.LOG_CATEGORIAS.get("log_event_handler_verbose", False)
...
if __name__ == '__main__':
    ...
    class MockJugador:
        ...
        def atacar(self):
            logger.info("MockJugador.atacar() llamado", extra={"categoria_log": "log_event_handler"})
    ...
    class MockAttackProfileManager:
        ...
        def seleccionar_perfil_ataque(self, nombre_perfil):
            ...
            logger.info(f"MockAPM.seleccionar_perfil_ataque({nombre_perfil})", extra={"categoria_log": "log_event_handler"})
        ...
        def set_parametro_ataque_activo(self, nombre_param, valor):
            ...
            logger.info(f"MockAPM.set_parametro_ataque_activo({nombre_param}, {valor})", extra={"categoria_log": "log_event_handler"})
    ...
    class MockJuego:
        ...
        def actualizar_factor_zoom(self, nuevo_zoom):
            ...
            logger.info(f"MockJuego.actualizar_factor_zoom({nuevo_zoom})", extra={"categoria_log": "log_event_handler"})
    ...
    original_log_event_handler = settings.LOG_CATEGORIAS.get("log_event_handler")
    original_log_event_handler_verbose = settings.LOG_CATEGORIAS.get("log_event_handler_verbose")

    settings.MODO_DEBUG_LOGS = True
    settings.LOG_CATEGORIAS["log_event_handler"] = True
    settings.LOG_CATEGORIAS["log_event_handler_verbose"] = True # Activar para ver todos los eventos
    ...
    if original_log_event_handler is not None: settings.LOG_CATEGORIAS["log_event_handler"] = original_log_event_handler
    if original_log_event_handler_verbose is not None: settings.LOG_CATEGORIAS["log_event_handler_verbose"] = original_log_event_handler_verbose
